...
namespace ATMApp
{
	public class ATMApp : UserLogin, UserAccountAction, ITransaction
	{
		...
		public void InitializedData()
		{
			...
			{
				new UserAccount { Id = 1, FullName = "Developer", AccountNumber = 150677, CardNumber = 12347, CardPin = 2000, AccountBalance = 3000000, IsLocked = false },
				new UserAccount { Id = 2, FullName = "QA", AccountNumber = 150678, CardNumber = 12346, CardPin = 4321, AccountBalance = 2000000, IsLocked = false },
				new UserAccount { Id = 3, FullName = "UI", AccountNumber = 150679, CardNumber = 12345, CardPin = 1234, AccountBalance = 5000000, IsLocked = false }
			};
